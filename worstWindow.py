...
class worstWindowClass:
    def __init__(self, master, fodboldtur):
        ...
        #TODONE Sorterer medlemmerne baseret på gæld, hvor de med mest gæld kommer først

        sorted_debtors = sorted(fodboldtur, key=lambda x: 4500 - fodboldtur[x], reverse=True)

        #TODONE Viser de tre medlemmer med mest gæld og hvor meget de mangler at betale
